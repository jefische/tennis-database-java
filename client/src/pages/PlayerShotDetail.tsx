					...
					<div ref={containerRef} className="h-[calc(100vh-64px)] overflow-auto px-4 py-8 sm:px-8 lg:px-16">
						<div className="mx-auto flex w-full max-w-5xl flex-col">
							...
							<div className="flex flex-col justify-center gap-8 xl:flex-row">
								...
								<aside className="hidden w-full shrink-0 lg:w-72 xl:w-80">
							...
							{/* Bottom Ad Banner */}
							<div className="hidden mt-12 flex h-24 items-center justify-center rounded-xl border-2 border-dashed border-border bg-muted/30">
