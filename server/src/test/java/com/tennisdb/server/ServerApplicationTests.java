...
public class ServerApplicationTests {
	...
	void testGetVideo_ByYoutubeId_Endpoint(){
		Video testVideo = new Video(4,"French Open", 2025, "ckbX699wngs", "Carlos Alcaraz", "Jannik Sinner", "Carlos Alcaraz vs Jannik Sinner | Roland-Garros 2025 Final (5hr 53min)", "Finals", null, null);
