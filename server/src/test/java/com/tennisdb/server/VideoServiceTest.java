...
public class VideoServiceTest {
	...
	public void testGetVideo(){
		...
		Video video1 = new Video(1, "Wimbledon", 2025, "http://example.com/video1", "Alcaraz", "Sinner", "Finals match", "Finals", null, null, null);
		Video video2 = new Video(2, "US Open", 2024, "http://example.com/video2", "Djokovic", "Shelton", "Quarterfinals match", "Quarterfinals", null, null, null);
	...
	public void testGetVideoById() {
		...
		Optional<Video> video1 = Optional.of(new Video(1, "Wimbledon", 2025, "http://example.com/video1", "Alcaraz", "Sinner", "Finals match", "Finals", null, null, null));
