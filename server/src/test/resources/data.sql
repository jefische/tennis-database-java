...
INSERT INTO videos (
    ...
    (
        ...
        'Jannik Sinner',
        'Alexander Zverev',
        'Jannik Sinner v Alexander Zverev | Australian Open 2025 Final (2hr 36min)',
        'Finals',
        'ai summary',
		'[''Epic'']',
		'no_transcript',
    ...
    (
        ...
        'Roger Federer',
        'Rafael Nadal',
        'Roger Federer vs Rafael Nadal | Wimbledon 2019 Semifinals (3hr 05min)',
        'Semifinals',
        'ai summary',
		'[''Epic'']',
		'no_transcript',
    ...
    (
        ...
        'Ben Shelton',
        'Frances Tiafoe',
        'Ben Shelton vs. Frances Tiafoe | 2023 US Open Quarterfinal (2hr 19min)',
        'Quarterfinals',
        'ai summary',
		'[''Epic'']',
		'no_transcript',
    ...
    (
        ...
        'Carlos Alcaraz',
        'Jannik Sinner',
        'Carlos Alcaraz vs Jannik Sinner | Roland-Garros 2025 Final (5hr 53min)',
        'Finals',
        'ai summary',
		'[''Epic'']',
		'no_transcript',
